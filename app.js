...
const gmtCronSchedule8 = "37 08 * * *";


//API Running check
const gmtCronSchedule5 = "30 08 * * *";
      ...
      if (!result || result.length === 0) {
        ...
        const mailOptions = {
          ...
          <html>
            ...
            <body>
              <h1>IT Inprocess Requirement List</h1>
              <table>
                <thead>
                  <tr>
                    <th>Req.NO</th>
    ...
    conn.query(sql, (err, result) => {
      ...
      if (!result || result.length === 0) {
        const mail = {
          ...
          html: `
          <p>IT New Closed Requirement List</p>
          <p>No data available "${formattedDates}"</p>`,
        };
